...
public class ColumnIntegerTableReaderTest extends AbstractTest {
  ...
  public Consumer<List<GenericRecord>> expected() {
    return recordList -> {
      ...
      assertThat(r1.get("c_utinyint"), is((short) 0));
      assertThat(r1.get("c_tinyint"), is((byte) 0));
      assertThat(r1.get("c_usmallint"), is(0));
      assertThat(r1.get("c_smallint"), is((short) 0));
      ...
      assertThat(r2.get("c_utinyint"), is((short) 1));
      assertThat(r2.get("c_tinyint"), is((byte) -1));
      assertThat(r2.get("c_usmallint"), is(1));
      assertThat(r2.get("c_smallint"), is((short) -1));
      ...
      assertThat(r3.get("c_utinyint"), is((short) 1));
      assertThat(r3.get("c_tinyint"), is((byte) 1));
      assertThat(r3.get("c_usmallint"), is(1));
      assertThat(r3.get("c_smallint"), is((short) 1));
      ...
      assertThat(r4.get("c_utinyint"), is((short) 100));
      assertThat(r4.get("c_tinyint"), is((byte) 100));
      assertThat(r4.get("c_usmallint"), is(10000));
      assertThat(r4.get("c_smallint"), is((short) 10000));
      ...
      assertThat(r5.get("c_utinyint"), is((short) 100));
      assertThat(r5.get("c_tinyint"), is((byte) -100));
      assertThat(r5.get("c_usmallint"), is(10000));
      assertThat(r5.get("c_smallint"), is((short) -10000));
      ...
      assertThat(r6.get("c_utinyint"), is((short) (Byte.MAX_VALUE - 1)));
      assertThat(r6.get("c_tinyint"), is((byte) (Byte.MAX_VALUE - 1)));
      assertThat(r6.get("c_usmallint"), is(Short.MAX_VALUE - 1));
      assertThat(r6.get("c_smallint"), is((short) (Short.MAX_VALUE - 1)));
      ...
      assertThat(r7.get("c_utinyint"), is((short) Byte.MAX_VALUE));
      assertThat(r7.get("c_tinyint"), is(Byte.MAX_VALUE));
      assertThat(r7.get("c_usmallint"), is((int) Short.MAX_VALUE));
      assertThat(r7.get("c_smallint"), is(Short.MAX_VALUE));
      ...
      assertThat(r8.get("c_utinyint"), is((short) (Byte.MAX_VALUE + 1)));
      assertThat(r8.get("c_tinyint"), is(Byte.MIN_VALUE));
      assertThat(r8.get("c_usmallint"), is(Short.MAX_VALUE + 1));
      assertThat(r8.get("c_smallint"), is(Short.MIN_VALUE));
      ...
      assertThat(r9.get("c_utinyint"), is((short) (Byte.MAX_VALUE + 2)));
      assertThat(r9.get("c_tinyint"), is((byte) (Byte.MIN_VALUE + 1)));
      assertThat(r9.get("c_usmallint"), is(Short.MAX_VALUE + 2));
      assertThat(r9.get("c_smallint"), is((short) (Short.MIN_VALUE + 1)));
