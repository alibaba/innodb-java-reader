  ...
  public void testRangeQueryIteratorNothingMysql(Consumer<AssertThat> func) {
    ...
    assertThat.withSql(sql())
        .checkRangeQueryIterator(rangeQueryNothingExpected(),
            ImmutableList.of("9999999999", 0, ""), ImmutableList.of("99999999999999999", 0, ""));

    assertThat = assertTestOf(this);
    func.accept(assertThat);
    assertThat.withSql(sql())
        .checkRangeQueryIterator(rangeQueryNothingExpected(),
            ImmutableList.of("", -1, ""), ImmutableList.of("", 0, ""));

    assertThat = assertTestOf(this);
    func.accept(assertThat);
    assertThat.withSql(sql())
        .checkRangeQueryIterator(rangeQueryNothingExpected(),
            ImmutableList.of("0", 0, ""), ImmutableList.of("0", 0, ""));

    assertThat = assertTestOf(this);
    func.accept(assertThat);
    assertThat.withSql(sql())
        .checkRangeQueryIterator(rangeQueryNothingExpected(),
            ImmutableList.of("9999999999", 0, ""), ImmutableList.of("9999999999", 0, ""));
  ...
  public void testCompositePkRangeQueryPartially(Consumer<AssertThat> func) {
    ...
    assertThat.withSql(sql())
        .checkRangeQueryIterator(expectedRangeQueryPartially(1000, 1, 1023 + 1, 4),
            ImmutableList.of("", 0, ""), ImmutableList.of("1023jjjj", 2, "2jjjj"));
    ...
    assertThat.withSql(sql())
        .checkRangeQueryIterator(expectedRangeQueryPartially(1002, 3, 1130 + 1, 2),
            ImmutableList.of("1002ooo", 2, "1002ooo"), ImmutableList.of("1130m", 1, "2m"));
    ...
    assertThat.withSql(sql())
        .checkRangeQueryIterator(expectedRangeQueryPartially(1773, 4, 1803 + 1, 2),
            ImmutableList.of("1773ffff", 2, "2ffff"), ImmutableList.of("1803jjjj", 1, "2jjjj"));

    assertThat.withSql(sql())
        .checkRangeQueryIterator(expectedRangeQueryPartially(1773, 1, 1803 + 1, 1),
            ImmutableList.of("1773ffff", 1, "1ffff"), ImmutableList.of("1803jjjj", 1, "1jjjj"));

    assertThat.withSql(sql())
        .checkRangeQueryIterator(expectedRangeQueryPartially(1773, 1, 1803 + 1, 1),
            ImmutableList.of("1773e", 1, "1ffff"), ImmutableList.of("1803jjjj", 1, "1jjjj"));

    assertThat.withSql(sql())
        .checkRangeQueryIterator(expectedRangeQueryPartially(1368, 3, 1368 + 1, 4),
            ImmutableList.of("1368qqqqqqqqq", 2, "1qqqq"), ImmutableList.of("1368qqqqqqqqq", 2, "2qqqq"));

    // mid, nothing
    assertThat.withSql(sql())
        .checkRangeQueryIterator(expectedRangeQueryPartially(1773, 1, 1774, 1),
            ImmutableList.of("1773g", 1, "1ffff"), ImmutableList.of("1774gggg", 2, "1jjjj"));
    ...
    assertThat.withSql(sql())
        .checkRangeQueryIterator(expectedRangeQueryPartially(1773, 1, 1803 + 1, 4 + 1),
            ImmutableList.of("1773ffff", 1, "1ffff"), ImmutableList.of("1803x", 1, "1jjjj"));

    assertThat.withSql(sql())
        .checkRangeQueryIterator(expectedRangeQueryPartially(1773 + 1, 1, 1803 + 1, 1),
            ImmutableList.of("1773ffff", Integer.MAX_VALUE, "1ffff"), ImmutableList.of("1803jjjj", 1, "1jjjj"));

    assertThat.withSql(sql())
        .checkRangeQueryIterator(expectedRangeQueryPartially(1773, 1, 1803 + 1, 4 + 1),
            ImmutableList.of("1773ffff", 1, "1ffff"), ImmutableList.of("1803jjjj", Integer.MAX_VALUE, "1jjjj"));

    // one group
    assertThat.withSql(sql())
        .checkRangeQueryIterator(expectedRangeQueryPartially(1998, 1, 1999 + 1, 1),
            ImmutableList.of("1998wwwwwwwww", 1, "1wwww"), ImmutableList.of("1999xxxxxxxxxx", 1, "1999xxxxxxxxxx"));

    // one group + 1 more row
    assertThat.withSql(sql())
        .checkRangeQueryIterator(expectedRangeQueryPartially(1998, 1, 1999 + 1, 2),
            ImmutableList.of("1998wwwwwwwww", 1, "1wwww"), ImmutableList.of("1999xxxxxxxxxx", 1, "2xxxxx"));

    // no upper
    assertThat.withSql(sql())
        .checkRangeQueryIterator(expectedRangeQueryPartially(1998, 1, 2000, 4 + 1),
            ImmutableList.of("1998wwwwwwwww", 1, "1wwww"), ImmutableList.of("2", 1, ""));

    // no upper
    assertThat.withSql(sql())
        .checkRangeQueryIterator(expectedRangeQueryPartially(1998, 1, 2000, 4 + 1),
            ImmutableList.of("1998wwwwwwwww", 1, "1wwww"), ImmutableList.of("1999xxxxxxxxxx", 2, "3"));
  }
